...
INSERT INTO role_permissions (role_id, permission) VALUES
  ...
  ('admin',   'inventory:allocate'), ('admin',   'inventory:adjust'),
  ...
  ('admin',   'inventory:allocate'), ('admin',   'inventory:adjust'),  ('admin',   'product:manage'),
  ('admin',   'rma:create'),
  ('manager', 'inventory:receive'),   ('manager', 'inventory:dispatch'),
  ('manager', 'inventory:allocate'), ('manager', 'inventory:adjust'),
  ...
  ('manager', 'inventory:allocate'), ('manager', 'inventory:adjust'),  ('manager', 'product:manage'),
  ('manager', 'rma:create'),
