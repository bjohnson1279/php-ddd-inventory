          ...
          <div className="card-lite">
            ...
            <form onSubmit={handleRegister}>
              <div className="form-group">
                ...
                <input id="regVariantId" value={regVariantId} onChange={e => setRegVariantId(e.target.value)} placeholder="e.g. 550e8400..." required />
              </div>
              <div className="form-group">
              ...
              <div className="card-lite">
                ...
                <form onSubmit={handleAction}>
                  ...
                  {actionType === 'restock' && (
                    <>
                      <div className="form-group">
                        <label htmlFor="actReturnId">Associated Return Claim ID</label>
                        <input id="actReturnId" value={actReturnId} onChange={e => setActReturnId(e.target.value)} placeholder="RET-8812" required />
                      </div>
                      <div className="form-group">
                        <label htmlFor="actCostCents">Re-boarding Value (in Cents)</label>
                        <input id="actCostCents" type="number" value={actCostCents} onChange={e => setActCostCents(e.target.value)} placeholder="e.g. 2400 for $24.00" required />
                      </div>
                    </>
                  )}
