...
ServiceContainer::dispatcher()->subscribe(\InventoryApp\Domain\Inventory\Events\ReturnProcessed::class, [$listener, 'handle']);

$processReturnBatch = new ProcessReturnBatch($repo, ServiceContainer::dispatcher());

$processReturnBatch->execute([
    ['sku' => 'TSHIRT-L-RED', 'location' => 'LOC-STOREFRONT', 'quantity' => 1, 'condition' => 'new'],
    ['sku' => 'PANTS-M-BLK', 'location' => 'LOC-STOREFRONT', 'quantity' => 1, 'condition' => 'new']
]);
