...
if ($driver === 'sqlite') {
    ...
    $capsule->addConnection([
        ...
        'password' => (getenv('DB_PASSWORD') !== false && getenv('DB_PASSWORD') !== '') ? getenv('DB_PASSWORD') : (getenv('APP_ENV') === 'testing' ? 'secret' : throw new \RuntimeException('DB_PASSWORD is required')),
