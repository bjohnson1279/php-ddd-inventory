...
class ManageApprovalWorkflowsTest extends TestCase
{
    ...
    {
        try {
            ApprovalWorkflowModel::whereNotNull('id')->delete();
            ApprovalRequestModel::whereNotNull('id')->delete();
        } catch (\Throwable $e) {}
    ...
    public function testSubmitDecisionDelegatesToService(): void
    {
        $this->serviceMock->expects($this->once())
            ...
            ->willReturn(['status' => 'APPROVED', 'referenceType' => 'PO', 'referenceId' => 'po_1']);
    ...
    public function testSubmitDecisionOnNonExistentRequestReturnsError(): void
    {
        $this->serviceMock->expects($this->once())
            ...
            ->willThrowException(new Exception("Approval request req_99 not found."));
