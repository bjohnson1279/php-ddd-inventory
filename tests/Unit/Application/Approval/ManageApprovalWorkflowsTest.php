...
class ManageApprovalWorkflowsTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->serviceMock = $this->createMock(ApprovalWorkflowService::class);
    ...
    {
        $this->serviceMock->expects($this->once())->method('processDecision')->with('req_1', 'user_1', 'APPROVED', 'Looks good')->willReturn(['status' => 'APPROVED', 'referenceType' => 'PO', 'referenceId' => 'po_1']);
    ...
    {
        $this->serviceMock->expects($this->once())->method('processDecision')->with('req_99', 'user_1', 'APPROVED', null)->willThrowException(new Exception("Approval request req_99 not found."));
